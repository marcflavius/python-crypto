...
class Blockchain(unittest.TestCase):
    ...
    def test_get_user_balance(self):
        blockchain.add_transaction(
            recipient="Bob", sender=blockchain.owner, amount=100,)
        blockchain.add_transaction(
            recipient="Bob", sender=blockchain.owner, amount=100,)
    ...
    def test_it_can_add_a_transaction_to_the_open_transaction_queue(self):
        ...
        self.assertEqual(blockchain.open_transaction, [
    ...
    def test_hash_a_blockchain(self):
        ...
        last_hash = "3acc5ced004146f444dbbefb339fa673994eb6553811f9511fce548c12f30f2e"
    ...
    def test_it_can_list_participants(self):
        ...
        self.assertEqual(
            blockchain.output_participant(participants),
            participants)
